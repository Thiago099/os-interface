...
export function set_resizable(value){
    resizable = value
    if(resizable)
    {
    ...
    {
        corner1.style.cursor = 'default'
        corner2.style.cursor = 'default'
        corner3.style.cursor = 'default'
        corner4.style.cursor = 'default'
...
export function resizeElement(element, minW = 100, minH = 100, size = 20)
{
    ...
    corner1 = document.createElement('div');
    ...
    corner2 = document.createElement('div');
    ...
    corner3 = document.createElement('div');
    ...
    corner4 = document.createElement('div');
